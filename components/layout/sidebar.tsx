    ...
    >
      ...
      <div style={{ padding: "18px 16px 14px", display: "flex", alignItems: "center", gap: 11 }}>
        ...
        <button
          ...
          style={{
            ...
            color: "var(--t3)", flexShrink: 0, transition: "all 0.15s",
          }}
      ...
      <nav style={{ flex: 1, padding: "8px 10px", overflowY: "auto" }} className="scrollbar-hide">
        {NAV.map(({ section, items }) => (
          <div key={section}>
            {!collapsed && (
              <div style={{ fontSize: 10, fontWeight: 500, letterSpacing: "0.09em", textTransform: "uppercase", color: "var(--t3)", padding: "12px 8px 5px" }}>
                {section}
              </div>
            )}
      ...
      {/* Footer */}
      <div style={{ padding: 10, borderTop: "0.5px solid var(--glass-border)" }}>
        <div
          style={{
            display: "flex", alignItems: "center", gap: 9,
