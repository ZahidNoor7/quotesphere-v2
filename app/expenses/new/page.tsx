...
const MobileExpItemCard = memo(function MobileExpItemCard({
  item,
  idx,
  currency,
  disableRemove,
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", marginBottom: 10 }}>
        ...
        <button
          ...
          style={{
            ...
            height: 26,
            borderRadius: 7,
            background: disableRemove ? "none" : "rgba(248,113,113,0.1)",
            border: disableRemove
              ? "none"
      ...
      >
        ...
        <span style={{ fontSize: 15, fontWeight: 700, color: T1 }}>
          {formatCurrency(localTotal, currency)}
        </span>
      </div>
    </div>
  );
      ...
      p.map((i) =>
        i.id === id
          ? {
              ...i,
              [k]:
                typeof v === "string" && k !== "name" && k !== "category"
                  ? parseFloat(v) || 0
                  : v,
            }
          : i,
                ...
                {items.map((item) => (
                  ...
                  >
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        upd(item.id, "unit_price", e.target.value)
                      }
